        ...
        <div className="flex justify-end items-center mt-5">
          {link && (
            <div
              ...
              className="cursor-pointer select-none rounded-full bg-[#3700ff] px-4 py-1 text-sm font-semibold text-white shadow-md transition-[background-color,box-shadow] duration-bends-fast ease-bends hover:bg-[#ff00f7]/90 sm:px-5 sm:py-2 sm:text-base"
            >
              Join
            </div>
          )}
