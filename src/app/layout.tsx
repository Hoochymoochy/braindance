...
export default function RootLayout({ children }: { children: ReactNode }) {
  return (
    <html lang="en" suppressHydrationWarning className={cn("overflow-x-clip overscroll-none font-sans", geist.variable)}>
      <head>
        <script dangerouslySetInnerHTML={{ __html: themeInitScript }} />
      </head>
      <body suppressHydrationWarning className="min-h-svh overflow-x-clip bg-[var(--page-bg)] text-zinc-900 font-sans overscroll-none">
