    ...
    <div className="min-h-screen bg-black thermal-background flex items-center justify-center">
      <div className="bg-black p-8 rounded-lg border border-purple-900/50 w-full max-w-md">
        ...
        <form onSubmit={handleLogin} className="space-y-5">
          <div>
            <label className="block text-xl text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-pink-400">Email</label>
            <input
              type="email"
              value={email}
          ...
          <div>
            <label className="block text-xl text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-pink-400">Password</label>
            <input
              type="password"
              value={password}
